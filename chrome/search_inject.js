(function(){
    ...
    var _last_keyword = '', fancyBlock = null;
    ...
    function draw(resp, query) {
        if(!fancyBlock) {
            ...
            style.innerHTML = '' + 
                ...
                '#fancyBlock>h2{margin:0;padding:0 0 10px 0;font-weight:normal;font-size:medium;background-image:url("data:image/png;base64,'+
                icecream_icon +
                ...
                '#fancyBlock>ul>li>div{display:table-cell;vertical-align:middle;text-align:center;width:140px;height:140px;background:#fff none repeat 0 0;background-image:url("data:image/png;base64,'+
                image_background+
                '");}' +
